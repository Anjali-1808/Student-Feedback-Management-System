...
<body>
	...
	<a href="index.php?page=Add_Faculty"><i class="fas fa-plus-circle"></i><span> Add Faculty</span></a>
	<a href="index.php?page=Add_Student"><i class="fas fa-plus-circle"></i><span> Add Student</span></a>
	<a href="index.php?page=manage_faculty"><i class="fas fa-tasks"></i><span> Manage Faculty</span></a>
