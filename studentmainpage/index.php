...
<body>
	...
	<a href="index.php?page=profile"><i class="fas fa-user"></i><span> Profile</span></a>
	
	<a href="index.php?page=feedback_form"><i class="fas fa-comment-dots"></i><span> Feedback</span></a>
