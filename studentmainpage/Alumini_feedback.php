...
<center><h3>Alumini Feedback</h3></center>
<table class="table table-bordered">
  <tr>
<td>
1. How would you rate acedemics of Your Department?</td>
<td>
...
<tr>
  <tr>
<td>
2. How would you rate laboratory equipments and machinery used in department?</td>
<td>
...
<tr>
<td>
3. Rate Your satisfaction with the inputs given by teaching staff of department.</td>
<td>
...
<tr>
<td>
4. Rate Your satisfaction with facilities such as internet / computer availability etc. provided by the department.</td>
<td>
...
<tr>
<td>
5. Rate Co-curicular activities (Industrial , Visit/Expert Lectures) conducted by  the department.</td>
<td>
...
<tr>
<td>
6. Rate housekeeping of the institute.</td>
<td>
...
<tr>
<td>
7. How will you rate your satisfaction with the co-operation of Administrative and Office Staff?</td>
<td>
...
$sql=mysqli_query($con,"select * from alumini_feedback where student_id='$user_id' and student_email='$email'");
...
echo "<h2 style='color:red'>You already given feedback..! </h2>";
  ...
  $query="Insert into alumini_feedback values('$user_id','$email','$quest1','$quest2','$quest3','$quest4',
