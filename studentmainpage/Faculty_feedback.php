...
<center><h3>Institute Faculty Feedback</h3></center>
<table class="table table-bordered">
  <tr>
<td>
1. Physical infrastructure of the Institute Library.</td>
<td>
...
<tr>
  <tr>
<td>
2. Collection of books ,journals and reading material of the Institute Library.</td>
<td>
...
<tr>
<td>
3. Support and Assistance of the Institute Office Staff.</td>
<td>
...
<tr>
<td>
4. Amentities and Assistance provided at the Institute Sports ground.</td>
<td>
...
<tr>
<td>
5. Co-operative store facility</td>
<td>
...
<tr>
<td>
6. Class room Infrastructure.</td>
<td>
...
$sql=mysqli_query($con,"select * from faculty_feedback where student_id='$user_id' and student_email='$email'");
...
echo "<h2 style='color:red'>You already given feedback..! </h2>";
  ...
  $query="Insert into faculty_feedback values('$user_id','$email','$quest1','$quest2','$quest3','$quest4',
